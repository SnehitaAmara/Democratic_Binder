...
<body>
	...
	<div class="wrapper">
		<div class="section">
			<div class="box-area">
				<h2 style="color: #2b2626">Welcome as a Admin</h2>
			</div>
		</div>
	</div>
</body>
