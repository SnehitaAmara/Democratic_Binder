...
<form action="/insertdata" class="myForm" method="POST" enctype="application/x-www-form-urlencoded">
	...
	<p>
		<label>Category <select id="pickup_place" name="category">
	...
	<p>
		<label>Statement <textarea name="statement" maxlength="500"></textarea>
		</label>
	</p>
	<p>
